...
// ---------------------------------------------------------------------------
// Light.jsx — ported from smartdatapresent/src/pages/smartlight/Story.jsx
// หน้า Smart Street Light แบบ storytelling เส้นเดียว (scroll ต่อกัน · ไม่ใช่ deck
// เด้งทีละสไลด์) · source: smartlight-prototype.html
// Recoloured from the Civic Trust palette to this app's Apple-blue palette —
// only the CSS custom-property block below was touched, structure untouched.
// NOTE: ตัด speaker hint / โน้ตภายในออกทั้งหมด — ไม่ render ขึ้นหน้าเว็บ
// ---------------------------------------------------------------------------

const INSTALL = 'images/smartlight/installation'
  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'rgba(0,86,184,0.55)', backdropFilter: 'blur(4px)',
    ...
    >
      ...
      >
          ...
          {DEMO_TABS.map((t) => (
            <button
              ...
              style={{
                ...
                boxShadow: tab === t.id ? '0 2px 6px rgba(0,113,227,0.3)' : 'none',
        ...
        <iframe
          key={active.id}
          src={asset(`ui/smartlight-demo/${active.file}`)}
...
function StoryStyles() {
  return (
    <style>{`
      ...
      .sl-story{
        --sl-primary:#0071e3; --sl-primary-hover:#1a80ee; --sl-primary-deep:#0056b8; --sl-primary-soft:#e8f2fe;
        --sl-accent:#c8781e; --sl-accent-soft:#fbf1e0; --sl-alert:#c0392b; --sl-alert-soft:#fbeae8;
        --sl-success:#1a8f4c; --sl-success-soft:#e8f5ee;
        --sl-cream:#f5f5f7; --sl-surface:#ffffff; --sl-surface-soft:#e8e8ed;
        --sl-text:#1d1d1f; --sl-text-muted:#6e6e73; --sl-line:#d2d2d7; --sl-maxw:1080px;
      ...
      .sl-story .card{background:#fff;border:1px solid var(--sl-line);border-radius:18px;padding:24px;box-shadow:0 4px 18px rgba(0,113,227,.05)}
      ...
      .sl-story .who .tag.b{background:var(--sl-accent)} .sl-story .who .tag.c{background:var(--sl-primary-deep)}
      ...
      .sl-story .btn:hover{background:#a8611a;transform:translateY(-2px)}
      ...
      .sl-story .divider.appendix{background:#1d1d1f}
    ...
    <div className="sl-story">
      ...
      <section>
        <div className="wrap">
          ...
          <div className="split">
            <div className="media"><img src={asset(`${INSTALL}/IMG_5052.jpeg`)} alt="โคมไฟ LED ติดตั้งจริงบนเสาไฟถนน" /></div>
            <div>
      ...
      <section>
        <div className="wrap">
          ...
          <div className="gallery">
            <img src={asset(`${INSTALL}/IMG_5052.jpeg`)} alt="ติดตั้งโคมไฟถนนจริง 1" />
            <img src={asset(`${INSTALL}/IMG_6040.jpeg`)} alt="ติดตั้งโคมไฟถนนจริง 2" />
            <img src={asset(`${INSTALL}/IMG_6042.jpeg`)} alt="ติดตั้งโคมไฟถนนจริง 3" />
          </div>
        </div>
      </section>
