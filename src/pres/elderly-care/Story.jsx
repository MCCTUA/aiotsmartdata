...
// ---------------------------------------------------------------------------
// Story.jsx — หน้า Elderly Care แบบ storytelling เส้นเดียว
// (scroll ต่อกัน · ไม่ใช่ deck เด้งทีละสไลด์)
// Ported from smartdatapresent/src/pages/ElderlyCareStory.jsx
// Design: recolored from Civic Trust palette to Repo B's "smartdata blue" palette
// NOTE: ตัด speaker hint / โน้ตภายในออกทั้งหมด — ไม่ render ขึ้นหน้าเว็บ
// ---------------------------------------------------------------------------

const IMG = asset('images/elderly-care')
...
// recolored: Civic Trust (forest/cream/amber) → smartdata blue palette
// ---------------------------------------------------------------------------
...
function StoryStyles() {
  return (
    <style>{`
      ...
      .ec-story{
        --ec-primary:#0071e3; --ec-primary-hover:#1a80ee; --ec-primary-deep:#0056b8; --ec-primary-soft:#e8f2fe;
        --ec-accent:#c8781e; --ec-accent-soft:#fbf1e0; --ec-alert:#c0392b; --ec-alert-soft:#fbeae8;
        --ec-success:#1a8f4c; --ec-success-soft:#e8f5ee;
        --ec-cream:#f5f5f7; --ec-surface:#ffffff; --ec-surface-soft:#e8e8ed;
        --ec-text:#1d1d1f; --ec-text-muted:#6e6e73; --ec-line:#d2d2d7; --ec-maxw:1080px;
      ...
      .ec-story .who .tag.b{background:var(--ec-accent)} .ec-story .who .tag.c{background:var(--ec-primary-deep)}
      ...
      .ec-story .btn:hover{background:#a8611a;transform:translateY(-2px)}
      ...
      .ec-story .divider.appendix{background:#1d1d1f}
