...
const PROBS = [
  ['ข้อมูลไม่ได้เก็บในไทย', ' — ปัญหาอธิปไตยข้อมูล งานราชการติดขัด'],
  ...
  return (
    <Section id="node" label="เราพัฒนา Node เอง">
      <SectionHeader
        ...
        lead="การซื้อโมดูลสำเร็จจากต่างประเทศมาขาย เจอปัญหาที่แก้เองไม่ได้เต็มไปหมด"
      />
      ...
      <FadeUp className="callout" style={{ marginTop: 30 }}>
        <div className="big">
          เราจึงตัดสินใจ <span className="hl">ทำเอง</span> — ค่อย ๆ พัฒนา “ช้าแต่ชัวร์”
          ให้ใช้งานได้จริง และคุมต้นทุนได้
        </div>
      </FadeUp>
      ...
      <FadeUp className="tl">
        <div className="tl-row">
          ...
          <div className="tl-body">
            ...
            <p>ติดที่ไหนก็คุยได้ · แลกกับค่าซิมรายเดือนทุกต้น + เปลืองพลังงาน</p>
          </div>
        </div>
        <div className="tl-row">
          <div className="tl-dot">
