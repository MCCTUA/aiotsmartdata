    ...
    <section className="hero" id="hero" data-label="ปก">
      ...
      <div className="wrap">
        <span className="badge">
          ผู้เชี่ยวชาญ AIOT Software + Lighting Hardware
        </span>
        <h1>
        ...
        <p className="sub">
          เราไม่ได้ขาย “อุปกรณ์” ที่ติดครั้งเดียวจบ — เราสร้าง “แพลตฟอร์ม”
          ที่ทำให้ทุกสิ่งที่คุณติดตั้ง
